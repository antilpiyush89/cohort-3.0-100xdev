  ...
  if (SidebarOpen) {
    return (
      <div className="fixed top-0 left-0 md:w-80 w-64 bg-white shadow-xl h-screen md:relative">
        <div className="fixed top-7 left-8 cursor-pointer " onClick={() => { setSidebarOpen(!SidebarOpen) }}>
          <SidebarToggle />
        </div>
          ...
          {SidebarData.map((ele) => {
            return (
              <div className="h-10 mb-15  ">
                ...
                {/* <div className="rounded-xl md:w-72 w-56 h-10 hover:bg-blue-800 opacity-10 ml-4 -translate-y-20 transition-all duration-300 ease-in-out"> */}
                {/* </div> */}
              </div>
            )
          })}
    ...
    return (
      ...
      <button className="fixed top-1 left-1 md:fixed md:top-7 md:left-8 text-white" onClick={() => { setSidebarOpen(!SidebarOpen) }}>
        <SidebarToggle />
      </button>
...
function MainContent({ }) {
  return (
    ...
    <div className="w-full">
      <div className="h-36 bg-black md:block hidden"></div>
      {/*  */}
      <div className="grid grid-cols-11 gap-8 p-8">
        <div className="h-96 md:col-span-3 col-span-11 bg-white -translate-y-24 rounded-2xl shadow-lg md:block hidden overflow-hidden">
          <div className="flex justify-center mb-10 pt-10"><img src={UserProfileData[0].img} alt="user-image" className="h-40 w-48 rounded-xl " /></div>
        ...
        <div className="h-72 mt-24 md:col-span-3 col-span-11 bg-yellow-200 rounded-2xl shadow-lg">
        </div>
      </div>
